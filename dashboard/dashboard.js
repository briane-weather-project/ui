...
if (savePhoneBtn) {
    savePhoneBtn.addEventListener('click', async () => {
        ...
        if (!phone) {
            showSettingsMsg('profile-msg', 'Please enter a phone number.', false);
            return;
        }
        if (!phone.startsWith('+')) {
            showSettingsMsg('profile-msg', 'Include country code (e.g. +63).', false);
            return;
        }
        ...
        try {
            ...
            showSettingsMsg('profile-msg', '✓ Phone number saved successfully!', true);
        } catch (err) {
            console.error('Save phone error:', err);
            showSettingsMsg('profile-msg', 'Failed to save. Try again.', false);
        } finally {
